...
for index, ligne in data.iterrows():
    sql = "INSERT INTO accident(age, date, heure,ville, longi,lati,added_status,id_gravite,id_descr_lum,id_descr_surface,id_descr_secu,id_descr_type_col,id_descr_intersection,id_descr_agglo,id_descr_cat_veh,code_insee,id_descr_athmo) VALUES (%s, %s, %s,%s, %s, %s,%s, %s,%s, %s, %s,%s, %s, %s,%s, %s)"
    val = ligne['age'], ligne['date'], ligne['heure'],ligne['longitude'],ligne['latitude'],0,ligne['descr_grav'],ligne['descr_lum'],ligne['descr_etat_surf'],ligne['descr_dispo_secu'],ligne['descr_type_col'],ligne['description_intersection'],ligne['descr_agglo'],ligne['descr_cat_veh'],ligne['id_code_insee'],ligne['descr_athmo']
