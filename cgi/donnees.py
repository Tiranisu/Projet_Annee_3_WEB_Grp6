...
for index, ligne in data.iterrows():
    sql = "INSERT INTO accident(age, date, heure, longi,lati,added_status,id_gravite,id_descr_lum,id_descr_surface,id_descr_secu,id_descr_type_col,id_descr_intersection,id_descr_agglo,id_descr_cat_veh,code_insee,id_descr_athmo) VALUES (%s, %s, %s,%s, %s, %s,%s, %s,%s, %s, %s,%s, %s, %s,%s, %s)"
